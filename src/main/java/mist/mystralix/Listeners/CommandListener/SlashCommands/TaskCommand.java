...
import mist.mystralix.Listeners.CommandListener.CommandObjects.TaskFunctions;
    ...
    */
    ...
    public SubcommandData[] getSubcommands() {
        return new SubcommandData[] {
                new SubcommandData("add", "Creating tasks/adding tasks to your task list.")
                    .addOptions(
                        new OptionData(
                                OptionType.STRING,
                                "title",
                ...
                new SubcommandData("cancel", "Updates specified task's status as cancelled.")
                    .addOptions(
                        new OptionData(
                                OptionType.INTEGER,
                                "task_id",
                ...
                new SubcommandData("delete", "Deletes a specific task selected using its task ID.")
                    .addOptions(
                        new OptionData(
                                OptionType.INTEGER,
                                "task_id",
                ...
                new SubcommandData("list", "Lists all the tasks regardless of status: completed, in progress, archived, or cancelled.")
                    .addOptions(
                        new OptionData(
                                OptionType.INTEGER,
                                "type",
                ...
                new SubcommandData("update", "Updates information: title, description, or task status, of an existing task.")
                    .addOptions(
                        new OptionData(
                                OptionType.INTEGER,
                                "id",
                ...
                new SubcommandData("view", "View a specific task selected using its task ID.")
                    .addOptions(
                        new OptionData(
                                OptionType.INTEGER,
                                "task_id",
    ...
    public void execute(SlashCommandInteraction event) {
        ...
        TaskFunctions task = new TaskFunctions();
